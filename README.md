...
* **Azure OpenAI and GPU Quota**
  ...
  - Note: When using Azure ML, you need adequate capacity in your ML workspace quota, which is separate from and managed independently of your subscription GPU quota.
